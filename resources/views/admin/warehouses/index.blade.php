                        ...
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover mb-0">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.warehouses.show', $warehouse->id) }}"
                                                       class="btn btn-sm btn-outline-info box-shadow-2 mr-1" title="جرد المخزن">
                                                    ...
                                                    <form action="{{ route('admin.warehouses.destroy', $warehouse->id) }}" method="POST" style="display:inline">
                                                        ...
                                                        <button type="submit" class="btn btn-sm btn-outline-danger box-shadow-2"
                                                                onclick="return confirm('هل أنت متأكد من حذف هذا المخزن؟ سيتم حذف الأرصدة المرتبطة به!')">
                                                            <i class="ft-trash"></i>
                                                        </button>
                                                    </form>
                                                </div>
                                    ...
                                    @empty
                                        <tr><td colspan="7" class="text-center py-3 text-muted">لا توجد مخازن مضافة حالياً.</td></tr>
                                    @endforelse
                                    </tbody>
                                </table>
                            </div>
